...
class Talk(object):
    ...
    @loggedIn
    def sendReplyGift(self, khieid, to, productId, productType):
        ...
        return self.sendReplyMessage(khieid, to, '', contentMetadata, 9)

    @loggedIn
    def sendReplyContact(self, khieid, to, mid):
        contentMetadata = {'mid': mid}
        return self.sendReplyMessage(khieid, to, '', contentMetadata, 13)
